...
import { BeneficiaireNewRoutingModule } from './beneficiaire-new-routing.module';
import { BeneficiaireNewComponent } from './beneficiaire-new.component';


@NgModule({
  declarations: [
    BeneficiaireNewComponent
  ],
  imports: [
    CommonModule,
    BeneficiaireNewRoutingModule,
     FormsModule,
...
export class BeneficiaireNewModule { }
